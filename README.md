...
![](examples/overview/build/figures/ppt_md_merger_overview_slide1_fig_14.png)
...
![](examples/overview/build/figures/ppt_md_merger_overview_slide2_fig_14.png)
...
![](examples/overview/build/figures/ppt_md_merger_overview_slide3_fig_14.png)
...
![](examples/overview/build/figures/ppt_md_merger_overview_slide4_fig_14.png)
...
![](examples/overview/build/figures/ppt_md_merger_overview_slide5_fig_14.png)
...
![](examples/overview/build/figures/ppt_md_merger_overview_slide6_fig_14.png)
...
![](examples/overview/build/figures/ppt_md_merger_overview_slide7_fig_14.png)
...
![](examples/overview/build/figures/ppt_md_merger_overview_slide8_fig_14.png)
...
![](examples/overview/build/figures/ppt_md_merger_overview_slide9_fig_14.png)
...
![](examples/overview/build/figures/ppt_md_merger_overview_slide10_fig_14.png)
...
![](examples/overview/build/figures/ppt_md_merger_overview_slide11_fig_14.png)
...
![](examples/overview/build/figures/ppt_md_merger_overview_slide12_fig_14.png)
...
[![サンプル：単純マージ](examples/overview/build/figures/simple_ppt_merge_guide_keyvisual_14.png)](examples/pm1_simple_ppt_merge/README.md)
...
[![サンプル：簡易ナンバリング](examples/overview/build/figures/simple_numbering_guide_keyvisual_14.png)](examples/pm2_simple_numbering/README.md)
...
[![サンプル：chapter_marker によるナンバリング](examples/overview/build/figures/chapter_marker_numbering_guide_keyvisual_14.png)](examples/pm3_chapter_marker_numbering/README.md)
...
[![サンプル：スライド中の変数置換](examples/overview/build/figures/variable_replacement_guide_keyvisual_14.png)](examples/pm4_variable_replacement/README.md)
...
[![サンプル：Chapter Cover 挿入運用](examples/overview/build/figures/chapter_cover_insertion_guide_keyvisual_14.png)](examples/pm5_chapter_cover_insertion/README.md)
...
[![サンプル：stylebaseを別に指定する機能](examples/overview/build/figures/stylebase_guide_keyvisual_14.png)](examples/pm6_stylebase/README.md)
...
[![サンプル：ファイルの分割挿入機能](examples/overview/build/figures/splitted_insertion_guide_keyvisual_14.png)](examples/pm7_splitted_insertion/README.md)
...
[![サンプル：指定したシェイプを消去](examples/overview/build/figures/delete_csp_guide_keyvisual_14.png)](examples/pm8_delete_csp/README.md)
...
[![サンプル：指定したスライドを削除](examples/overview/build/figures/delete_csl_guide_keyvisual_14.png)](examples/pm9_delete_csl/README.md)
...
[![サンプル：作業用のメモを書く](examples/overview/build/figures/memo_temp_guide_keyvisual_14.png)](examples/pm10_memo_temp/README.md)
...
[![サンプル：特殊定数を置換する](examples/overview/build/figures/title_filename_guide_keyvisual_14.png)](examples/pm11_title_filename/README.md)