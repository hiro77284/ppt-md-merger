...
![](figures/simple_numbering_guide_slide1_fig.png){ width=95% }

![](figures/simple_numbering_guide_keyvisual.png){ width=70% }
...
![](figures/simple_numbering_guide_slide3_fig.png){ width=95% }
